...
$sql = "SELECT Name, Price, Description, Request FROM Table15";
...
<form method="POST">
    ...
    <?php 
    $Name = $_POST['Name'];
    $sql2 = "DELETE FROM Table15 WHERE Name = ('$Name')";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE Table15 SET Request='$request' WHERE Name='$name'";
