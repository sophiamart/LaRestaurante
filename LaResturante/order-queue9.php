...
$sql = "SELECT Name, Price, Description, Request FROM Table9";
...
<form method="POST">
    ...
    <?php 
    $Name = $_POST['Name'];
    $sql2 = "DELETE FROM Table9 WHERE Name = ('$Name')";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE Table9 SET Request='$request' WHERE Name='$name'";
