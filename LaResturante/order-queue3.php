...
$sql = "SELECT Name, Price, Description, Request FROM Table3";
...
<form method="POST">
    ...
    <?php 
    $Name = $_POST['Name'];
    $sql2 = "DELETE FROM Table3 WHERE Name = ('$Name')";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE Table3 SET Request='$request' WHERE Name='$name'";
