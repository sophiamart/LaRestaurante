...
$sql = "SELECT Name, Price, Description, Request FROM Table11";
...
<form method="POST">
    ...
    <?php 
    $Name = $_POST['Name'];
    $sql2 = "DELETE FROM Table11 WHERE Name = ('$Name')";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE Table11 SET Request='$request' WHERE Name='$name'";
