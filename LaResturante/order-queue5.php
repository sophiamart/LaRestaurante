...
$sql = "SELECT Name, Price, Description, Request FROM Table5";
...
<form method="POST">
    ...
    <?php 
    $Name = $_POST['Name'];
    $sql2 = "DELETE FROM Table5 WHERE Name = ('$Name')";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE Table5 SET Request='$request' WHERE Name='$name'";
