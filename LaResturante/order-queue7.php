...
$sql = "SELECT Name, Price, Description, Request FROM Table7";
...
<form method="POST">
    ...
    <?php 
    $Name = $_POST['Name'];
    $sql2 = "DELETE FROM Table7 WHERE Name = ('$Name')";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE Table7 SET Request='$request' WHERE Name='$name'";
