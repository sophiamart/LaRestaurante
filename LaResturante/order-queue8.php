...
$sql = "SELECT Name, Price, Description, Request FROM Table8";
...
<form method="POST">
    ...
    <?php 
    $Name = $_POST['Name'];
    $sql2 = "DELETE FROM Table8 WHERE Name = ('$Name')";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE Table8 SET Request='$request' WHERE Name='$name'";
