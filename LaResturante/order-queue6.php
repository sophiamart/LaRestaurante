...
$sql = "SELECT Name, Price, Description, Request FROM Table6";
...
<form method="POST">
    ...
    <?php 
    $Name = $_POST['Name'];
    $sql2 = "DELETE FROM Table6 WHERE Name = ('$Name')";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE Table6 SET Request='$request' WHERE Name='$name'";
