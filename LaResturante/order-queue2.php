...
$sql = "SELECT Name, Price, Description, Request FROM Table2";
...
<form method="POST">
    ...
    <?php 
    $Name = $_POST['Name'];
    $sql2 = "DELETE FROM Table1 WHERE Name = ('$Name')";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE Table2 SET Request='$request' WHERE Name='$name'";
