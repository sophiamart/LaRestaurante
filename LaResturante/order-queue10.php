...
$sql = "SELECT Name, Price, Description, Request FROM Table10";
...
<form method="POST">
    ...
    <?php 
    $Name = $_POST['Name'];
    $sql2 = "DELETE FROM Table10 WHERE Name = ('$Name')";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE Table10 SET Request='$request' WHERE Name='$name'";
