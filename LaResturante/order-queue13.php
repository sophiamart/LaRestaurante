...
$sql = "SELECT Name, Price, Description, Request FROM Table13";
...
<form method="POST">
    ...
    <?php 
    $Name = $_POST['Name'];
    $sql2 = "DELETE FROM Table13 WHERE Name = ('$Name')";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE Table13 SET Request='$request' WHERE Name='$name'";
