...
$sql = "SELECT Name, Price, Description, Request FROM Table14";
...
<form method="POST">
    ...
    <?php 
    $Name = $_POST['Name'];
    $sql2 = "DELETE FROM Table14 WHERE Name = ('$Name')";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE Table14 SET Request='$request' WHERE Name='$name'";
