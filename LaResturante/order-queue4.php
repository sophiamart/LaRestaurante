...
$sql = "SELECT Name, Price, Description, Request FROM Table4";
...
<form method="POST">
    ...
    <?php 
    $Name = $_POST['Name'];
    $sql2 = "DELETE FROM Table4 WHERE Name = ('$Name')";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE Table4 SET Request='$request' WHERE Name='$name'";
