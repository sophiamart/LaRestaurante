...
$sql = "SELECT Name, Price, Description, Request FROM Table16";
...
<form method="POST">
    ...
    <?php 
    $Name = $_POST['Name'];
    $sql2 = "DELETE FROM Table16 WHERE Name = ('$Name')";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE Table16 SET Request='$request' WHERE Name='$name'";
